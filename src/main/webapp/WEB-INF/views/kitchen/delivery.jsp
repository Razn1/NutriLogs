                        ...
                        <form action="<%= request.getContextPath()%>/kitchen/delivery/submit" method="POST"
                            ...
                            <div class="mb-1">
                                <label for="school" class="form-label small fw-medium">Sekolah
                                    Tujuan</label>
                                <select name="schoolId" id="school" required class="form-select form-select-lg">
                            ...
                            <!-- Vehicle Selection -->
                            <div class="mb-1">
                                <label for="vehicle" class="form-label small fw-medium">Kendaraan</label>
                                <select name="vehicleId" id="vehicle" required class="form-select form-select-lg">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="number" id="quantity" name="jumlahKirim" required min="1"
                                       class="form-control form-control-lg" placeholder="Masukkan jumlah porsi">
                            </div>
